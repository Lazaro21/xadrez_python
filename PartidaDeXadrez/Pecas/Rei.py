...
class Rei(Peca):
    ...
    def jogadas_possiveis(self):
        ...
        p = Posicao(self.posicao.linha, self.posicao.coluna)
        ...
        # noroeste
        p = Posicao(self.posicao.linha - 1, self.posicao.coluna - 1)
        if self.pode_mover(p):
            movimentos_possiveis[p.linha][p.coluna] = True
            
        # esquerda
        p = Posicao(self.posicao.linha, self.posicao.coluna - 1)
        if self.pode_mover(p):
            movimentos_possiveis[p.linha][p.coluna] = True
        ...
        # abaixo
        p = Posicao(self.posicao.linha + 1, self.posicao.coluna)
        if self.pode_mover(p):
            movimentos_possiveis[p.linha][p.coluna] = True
